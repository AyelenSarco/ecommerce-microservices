...
* The original package name 'com.ecommerce-microservices.config-service' is invalid and this project uses 'com.ecommerce_microservices.config_service' instead.
