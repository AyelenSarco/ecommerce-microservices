package com.ecommerce_microservices.sales_service.dto;

import com.ecommerce_microservices.sales_service.exception.ApiError;
...
public class ApiResponse<T> {
    ...
    public static <T> ApiResponse<T> failure(String message, List<ApiError> errors, T data){
